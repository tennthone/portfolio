...
const ProfileDetail = () => {
    ...
    const { socialProfiles, addSocialProfile } =
        useSocialProfiles(data.social);
        ...
        <React.Fragment>
            <form onSubmit={update}>
                <div className="my-3">
                                ...
                                {profiles.length > 0 &&
                                    profiles.map((item) => (
                                        <span 
                                            key={item.id}
                                            className={
                                                `me-4 hover:border-4 border-indigo-700 rounded-full ${
                                                    checkProfileExist(item.id) ? 'border-4 border-green-500 rounded-full' : ''
                                                }`
                                            }
                                        >
                                            <img 
                    ...
                    {/* social media fields  */}
                    <div className="mt-5">
                    {socialProfiles.length > 0 && socialProfiles.map(item => (
                        <SocialProfile 
                            labelName={item.name}
                            value={item.value}
