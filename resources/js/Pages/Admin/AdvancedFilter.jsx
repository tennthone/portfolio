                        ...
                        <div className="flex my-3">
                            <div className="w-1/2 me-2">
                                ...
                                <TextInput
                                    type="date"
                                    id="startDate"
                                    value={advancedFilter.createdAt.startDate}
                            ...
                            <div className="w-1/2">
                                ...
                                <TextInput 
                                    type="date"
                                    id="endDate"
                                    value={advancedFilter.createdAt.endDate}
                                    onChange={(e) => handleDateFilterChange(e)}
                                />
                            </div>
                        </div>
                        ...
                        <div className="flex my-3">
                            <div className="w-1/2 me-2">
                                ...
                                <div className="flex justify-between">
                                    <Select
                                        id="startYear"
                                        value={advancedFilter.createdAt.startYear}
                                    ...
                                    <Select
                                        id="startMonth"
                                        value={advancedFilter.createdAt.startMonth}
                                        className="1/3"
                                        onChange={(e) => handleDateFilterChange(e)}
                                    >
                            ...
                            <div className="w-1/2 me-2">
                                ...
                                <div className="flex justify-between">
                                    <Select
                                        id="endYear"
                                        value={advancedFilter.createdAt.endYear}
                                        className="w-2/3 me-2"
                                        onChange={(e) => handleDateFilterChange(e)}
                                    >
                                        <option value="">YY</option>
                                    ...
                                    <Select
                                        id="endMonth"
                                        value={advancedFilter.createdAt.endMonth}
                                        className="1/3"
                                        onChange={(e) => handleDateFilterChange(e)}
                                    >
                                        <option value=""> MM </option>
